...
const WeatherInfo = ({
 ...
 // );
  ...
  const temperaturaDisplay = Celsius
    ? main.temp
    : convertorFahrenheit(main.temp);
  const feelsLikeDisplay = Celsius
    ? main.feels_like
    : convertorFahrenheit(main.feels_like);
  const temperaturaMax = Celsius
    ? main.temp_max
    : convertorFahrenheit(main.temp_max);
  const temperaturaMin = Celsius
    ? main.temp_min
    : convertorFahrenheit(main.temp_min);
  ...
  if (
    (wind.deg >= 0 && wind.deg <= 20) ||
    (wind.deg >= 340 && wind.deg <= 360)
  ) {
    ...
    <div className="complementos">
       <div className="div_parag">
        {main.temp !== undefined ? (
          ...
          <p>
            <span className={main.temp !== undefined ? "" : "dados_ind"}>
              {main.temp !== undefined
                ? main.temp
        ...
        {main.feels_like !== undefined ? (
          ...
          <p>
            Sensação de{" "}
            <span className={main.feels_like !== undefined ? "" : "dados_ind"}>
              {main.feels_like !== undefined
                ? main.feels_like
                : "Indisponível nessa região"}
            </span>{" "}
        ...
        {main.temp_max !== undefined || main.temp_min !== undefined ? (
          <p>
            {"Máx: " + temperaturaMax.toFixed(0)}
            {Celsius ? "°C " : "°F "} | {"Min: " + temperaturaMin.toFixed(0)}
            {Celsius ? "°C " : "°F "}
          </p>
        ) : (
          <p>
            Máx:{" "}
            <span className={main.temp_max !== undefined ? "" : "dados_ind"}>
              {main.temp_max !== undefined
                ? main.temp_max
                : "Indisponível nessa região"}
            </span>{" "}
            | Min:{" "}
            <span className={main.temp_min !== undefined ? "" : "dados_ind"}>
              {main.temp_min !== undefined
                ? main.temp_min
                : "Indisponível nessa região"}
            </span>{" "}
            {Celsius ? "°C" : "°F"}
        ...
        {wind.speed !== undefined ? (
          <p>
            velocidade do vento:&nbsp;{convertToKmh(wind.speed).toFixed(0)} km/h
          </p>
        ) : (
          <p>
            velocidade do vento:
            <span className={wind.speed !== undefined ? "" : "dados_ind"}>
              {wind.speed !== undefined
                ? wind.speed + "km/h"
                : "Indisponível nessa região"}
            </span>
        ...
        {wind.gust !== undefined ? (
          ...
          <p>
            Rajada de:{" "}
            <span className={wind.gust !== undefined ? "" : "dados_ind"}>
              {wind.gust !== undefined
                ? wind.gust + "km/h"
                : "Indisponível nessa região"}
            </span>
      ...
      {/* <div className="div_parag">
        {visibility !== undefined ? (
          ...
          <p>
            Humidade:{" "}
            <p className="dados_ind">
              <span className={visibility !== undefined ? "" : "dados_ind"}>
                {visibility !== undefined
                  ? visibility + "Km de Visibilidade"
                  : "Indisponível nessa região"}
              </span>
            </p>
          </p>
        ...
        {main.humidity !== undefined ? (
          ...
          <p>
            Humidade:{" "}
            <p className="dados_ind">
              <span className={main.humidity !== undefined ? "" : "dados_ind"}>
                {main.humidity !== undefined
                  ? main.humidity + "% de Humidade"
                  : "Indisponível nessa região"}
              </span>
            </p>
          </p>
        ...
        {main.pressure !== undefined ? (
          ...
          <p>
            Pressão atmosférica (Mar):{" "}
            <span className={main.pressure !== undefined ? "" : "dados_ind"}>
              {main.pressure !== undefined
                ? main.pressure + "hPa"
                : "Indisponível nessa região"}
            </span>
        ...
        {main.grnd_level !== undefined ? (
          ...
          <p>
            Pressão atmosférica (Solo):{" "}
            <span className={main.grnd_level !== undefined ? "" : "dados_ind"}>
              {main.grnd_level !== undefined
                ? main.grnd_level + "hPa"
                : "Indisponível nessa região"}
            </span>
